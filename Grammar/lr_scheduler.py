...
"""
acknowledge from: https://github.com/CoinCheung/BiSeNet/blob/master/lib/lr_scheduler.py
"""
...
if __name__ == "__main__":
    ...
    epochs = 10
    step_per_epoch = 200
    lr_scheduler = WarmupPolyLrScheduler(optim, 0.9, epochs, warmup_iter=1,
                                         warmup_ratio=1./3, warmup='linear', last_epoch=-1)
    lrs = []
    for epoch in range(epochs):
        for step in range(step_per_epoch):
            ...
            print(lr)
            lrs.append(lr)
            lr_scheduler.step(epoch + step/step_per_epoch)
    import matplotlib
