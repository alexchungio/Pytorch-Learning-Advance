...
# -*- coding: utf-8 -*-
#------------------------------------------------------
# @ File       : gru_char_generator.py
# @ Description:  
# @ Author     : Alex Chung
# @ Contact    : yonganzhong@outlook.com
# @ License    : Copyright (c) 2017-2018
# @ Time       : 2020/10/28 下午5:52
# @ Software   : PyCharm
#-------------------------------------------------------
...
class GRUModel(nn.Module):
    def __init__(self, hidden_size, vocab_size, embedding_dim, bidirectional=False):
        ...
        self.gru = nn.GRU(input_size=embedding_dim, hidden_size=self.hidden_size, bidirectional=bidirectional,
                           batch_first=True)
    ...
    def forward(self, inputs, state): # inputs: (seq_len, time_steps)
        ...
        out, self.state = self.gru(x, state)
